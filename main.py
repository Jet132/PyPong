...
# init PyPong
env = PyPong.PyPong(field_size=(width, height), player_size=player_size,
                    ball_size=ball_size, player_speed=8, start_velocity=4)
env.reset()
...
while not terminal:
    ...
    pygame.draw.rect(screen, BLACK, [
                     ball[0]*scaling, ball[1]*scaling, ball_size*scaling, ball_size*scaling])
    # players
    pygame.draw.rect(
        screen, BLACK, [0, player0*scaling, player_width, player_size*scaling])
    pygame.draw.rect(screen, BLACK, [
                     width*scaling-player_width, player1*scaling, player_width, player_size*scaling])
